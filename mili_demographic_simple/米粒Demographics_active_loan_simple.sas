...
if od_days>5 then od5=1;else od5=0;
if od_days>15 then od15=1;else od15=0;
if 客户标签=1 then output benzi.active_loan_activeloan_m_xz;
...
%demo_0(use_database=benzi.active_loan_activeloan_m_B,i=21);
proc sql;
...
filename DD DDE 'EXCEL|[Monthly_Demographics(米粒_total)_simple.xlsx]Active Loan!r5c33:r400c35';
data _null_;
...
filename DD DDE 'EXCEL|[Monthly_Demographics(米粒_新客户)_simple.xlsx]Active Loan!r5c33:r400c35';
data _null_;
