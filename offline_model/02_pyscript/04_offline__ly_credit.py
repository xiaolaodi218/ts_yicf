...
df = pd.read_csv(r'F:\TS\offline_model\01_Dataset\02_Interim\orig_data_4.csv')
...
#导入WOE
woe = pd.read_excel(r"F:\TS\offline_model\02_DataProcess\03_best_IV\02_read_woe_dull_02.xlsx")
print(len(woe.var_name.drop_duplicates()))
woe = woe[woe.ori_IV >= 0.04]
...
confusion_matrix 
 [[ 975  611]
 [ 496 1097]]
accuracy_score 0.651777288455
precision_score 0.642271662763
recall_score 0.688637790333
ROC_AUC is 0.699094161167
K-S score 0.312025182684
'''
...
csvfile = r"F:\TS\offline_model\01_Dataset\04_Output\scorecard\03scorecard_best_bin_woe4.csv"
scorecard.to_csv(csvfile,sep=',',index=False ,encoding = 'utf-8')

scorecard = pd.read_csv(r"F:\TS\offline_model\01_Dataset\04_Output\scorecard\03scorecard_best_bin_woe4.csv")
...
iv_score_sum[1].to_excel(r"F:\TS\offline_model\02_DataProcess\05_result_score\model_result4.xlsx")
