********************************************************************************************************************
*active_loan;
data bjb.active_loan_activeloan_m_all;
set bjb.active_loan;
/*if 申请提交点_g="1.1-5点" ;*/
...
run;
**复贷 新客户;
data bjb.active_loan_activeloan_m_xz bjb.active_loan_activeloan_m_fd;
set bjb.active_loan;
if 账户标签 not in ("未放款","待还款");
if apply_code^="";
count=1;
if od_days>5 then od5=1;else od5=0;
if od_days>15 then od15=1;else od15=0;
if 客户标签=1 then output bjb.active_loan_activeloan_m_xz;
else if 客户标签^=1 then output bjb.active_loan_activeloan_m_fd;
run;
**冠军;
...
**获取逾期5+天的;
data bjb.active_loan_activeloan_5_all;
set bjb.active_loan_activeloan_m_all;
if od5=1;
run;
data bjb.active_loan_activeloan_5_xz;
set bjb.active_loan_activeloan_m_xz;
if od5=1;
run;
data bjb.active_loan_activeloan_5_fd;
set bjb.active_loan_activeloan_m_fd;
if od5=1;
run;
...
**获取逾期15+天的;
data bjb.active_loan_activeloan_15_all;
set bjb.active_loan_activeloan_m_all;
if od15=1;
run;
data bjb.active_loan_activeloan_15_xz;
set bjb.active_loan_activeloan_m_xz;
if od15=1;
run;
data bjb.active_loan_activeloan_15_fd;
set bjb.active_loan_activeloan_m_fd;
if od15=1;
run;
